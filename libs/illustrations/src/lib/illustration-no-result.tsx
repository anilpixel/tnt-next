...
function SvgIllustrationNoResult(
  ...
  return (
    ...
    >
      <style>
        {
          '.IllustrationNoResult_svg__B{fill:#fff}.IllustrationNoResult_svg__C{stroke-linejoin:round}.IllustrationNoResult_svg__D{stroke-width:.5}.IllustrationNoResult_svg__F{fill-rule:nonzero}'
        }
      </style>
      <defs>
        <circle
          id="IllustrationNoResult_svg__A"
          cx={67.514}
          cy={67.514}
          r={67.514}
        />
      ...
      <g transform="translate(.6)" fill="none" fillRule="evenodd">
        <g transform="translate(6.4)">
          <mask
            id="IllustrationNoResult_svg__B"
            className="IllustrationNoResult_svg__B"
          >
            <use xlinkHref="#IllustrationNoResult_svg__A" />
          </mask>
          <use fill="#f5f5f5" xlinkHref="#IllustrationNoResult_svg__A" />
          <g stroke="#1a1a1a" mask="url(#IllustrationNoResult_svg__B)">
            <g className="IllustrationNoResult_svg__D">
              <path
            ...
            <g className="IllustrationNoResult_svg__F IllustrationNoResult_svg__C">
              <g className="IllustrationNoResult_svg__D">
        ...
        <g stroke="#1a1a1a">
          <g className="IllustrationNoResult_svg__C IllustrationNoResult_svg__F">
            <path
            ...
            <path
              ...
              fill="#d6dae1"
              className="IllustrationNoResult_svg__D"
            />
          </g>
          <g
            transform="rotate(16 -174.273 340.865)"
            className="IllustrationNoResult_svg__B IllustrationNoResult_svg__D"
          >
        ...
        <circle
          ...
          cy={34.04}
          r={3}
          className="IllustrationNoResult_svg__F tnt-svg-primary-color"
        />
