...
If you can't find your language, you are welcome to create a locale package based on [en\_US](https://github.com/ant-design/ant-design/blob/master/components/locale-provider/en_US.tsx) and send us a pull request.
